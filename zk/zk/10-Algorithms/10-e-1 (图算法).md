...
> [!NOTE] BFS 广度优先搜索
> ![BFS](files/slides/Tsinghua-DSA-2024Fall-chapter/10.Graph.pdf#page=34&rect=0,0,960,540)
>
...
> [!NOTE] DFS 深度优先搜索
> ![DFS](files/slides/Tsinghua-DSA-2024Fall-chapter/10.Graph.pdf#page=56&rect=0,0,960,540)
>
...
> [!NOTE] 拓扑排序
> ![11.Graph Applications, 页面 3](files/slides/Tsinghua-DSA-2024Fall-chapter/11.Graph%20Applications.pdf#page=3&rect=0,0,960,540&selection=51,0,51,4)
...
> [!NOTE] BCC 双联通分量
> ![11.Graph Applications, 页面 3](files/slides/Tsinghua-DSA-2024Fall-chapter/11.Graph%20Applications.pdf#page=14&rect=0,0,960,540)
...
> ![11.Graph Applications, 页面 3](files/slides/Tsinghua-DSA-2024Fall-chapter/11.Graph%20Applications.pdf#page=30&rect=0,0,960,540)
>
...
> [!NOTE] dijkstra算法
> ![11.Graph Applications, 页面 3](files/slides/Tsinghua-DSA-2024Fall-chapter/11.Graph%20Applications.pdf#page=35&rect=0,0,960,540)
>
...
> [!NOTE] Floyd-Warshall
> ![11.Graph Applications, 页面 3](files/slides/Tsinghua-DSA-2024Fall-chapter/11.Graph%20Applications.pdf#page=92&rect=0,0,960,540)
>
...
> [!NOTE] prim算法
> ![11.Graph Applications, 页面 3](files/slides/Tsinghua-DSA-2024Fall-chapter/11.Graph%20Applications.pdf#page=58&rect=0,0,960,540)
>
> - 众多优化问题的基本模型
> - 为许多NP问题提供足够好的近似解
>
...
> [!NOTE] Kruskal算法
> ![11.Graph Applications, 页面 3](files/slides/Tsinghua-DSA-2024Fall-chapter/11.Graph%20Applications.pdf#page=79&rect=0,0,960,540)
>
